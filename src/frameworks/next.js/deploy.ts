...
import { defaultFirebaseToolsOptions, DeployConfig, PathFactory } from "../../utils";
import winston from "winston";
import tripleBeam from 'triple-beam';
import chalk from "chalk";

export const deploy = async (config: Required<DeployConfig>, getProjectPath: PathFactory) => {
