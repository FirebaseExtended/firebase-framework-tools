...
if (expectedRange !== createNextAppVersionRange) throw `expected create-next-app version requirement to equal ${expectedRange}`;
if (expectedRange !== nextVersionRange )  throw `expected next version requirement to equal ${expectedRange}`;
